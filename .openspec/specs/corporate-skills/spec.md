# Corporate Skills Specification

## Purpose

Admin-managed, versioned SKILL.md catalog with per-project assignments,
fail-closed policy, and a CLI read API. Backed by three tables:
`corporate_skills`, `corporate_skill_versions`, and
