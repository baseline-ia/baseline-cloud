...
The complete step-by-step deployment guide is available in [Spanish at `docs/deployment.md`](docs/deployment.md). It covers Compose, Dockerfile/container platforms, native execution, environment variables, migrations, bootstrap admin, health checks, backups, rollback, CLI configuration, and troubleshooting.
...
See [`docs/deployment.md`](docs/deployment.md) for the commands and the required post-deployment project enrollment step.
